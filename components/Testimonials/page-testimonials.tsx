...
export function TestimonialsSection() {
  ...
  return (
    <section className="w-full bg-zinc-900 py-24 md:py-32 border-b border-zinc-700/30" style={{ fontFamily: "'Product Sans', system-ui, sans-serif" }}>
        ...
        <div className="flex flex-col gap-6 mb-16">
          ...
          <div className="flex items-center justify-between gap-8">
            <h2 className="text-balance text-4xl md:text-5xl font-normal text-white">
              {"What Security Leaders Say About Skydda."
                .split(" ")
                .map((word, i) => (
                  <motion.span
                    key={i}
