...
export function SolutionSection() {
  ...
  return (
    <section className="w-full bg-zinc-900 text-white py-24 flex flex-col items-center overflow-hidden border-b border-zinc-700/30" style={{ fontFamily: "var(--font-rethink-sans), system-ui, sans-serif" }}>
